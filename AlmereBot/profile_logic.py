...
COMMUTER_PROFILES = {
    "Peak Routine Traveller": {
        "description": "A person with a fixed traveling schedule, that travels during peak periods and less likely to change their plans, even when faced with crowding.",
        "logic_keywords": " Morning peak and evening peak, fixed schedule (5+ days/week), low flexibility, low digital openness, takes the bus anyway when crowded."
    },
    "Flexible Avoider": {
    ...
    "Adaptive Off-Peak Traveller": {
        "description": " A commuter who is flexible who riders off-peak period. Their choices are context-driven, and they are open to new tools and ideas but not necessarily proactive planners.",
